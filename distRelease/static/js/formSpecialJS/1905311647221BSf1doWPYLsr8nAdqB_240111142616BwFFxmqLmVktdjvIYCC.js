...
(function () {
    ...
    exportObj.initHandle = function (formData, formStruct, vueData) {
        ...
        if (meetingId && dsf.util.loadSessionStore("checkedMettingStime")) {
            // formData.main["c-meetingsq-007"].value = dsf.util.loadSessionStore("checkedMettingStime") ? dsf.util.loadSessionStore("checkedMettingStime").value : null;
            ...
            //     value: dsf.util.loadSessionStore("checkedMettingStime") ? dsf.util.loadSessionStore("checkedMettingStime").value : null,
            //     text: dsf.util.loadSessionStore("checkedMettingStime") ? dsf.util.loadSessionStore("checkedMettingStime").value : null
            // })
        }
