...
;(function ($) {
     ...
     */
    $.kgi18n.properties = function (settings) {
        ...
        files.forEach(function (file) {
            ...
            loadAndParseFiles([longFileName], settings);
        });
     ...
     * Eg, jQuery.kgi18n.prop('com.company.bundles.menu_add')
     */
    $.kgi18n.prop = function (key /* Add parameters as function arguments as necessary  */) {
        ...
        var value = (namespace) ? $.kgi18n.map[namespace][key] : $.kgi18n.map[key];
        if (value === null) {
        ...
        */
        ...
        if (typeof(value) == 'string') {
            ...
            if (namespace) {
                $.kgi18n.map[settings.namespace][key] = arr;
            } else {
                $.kgi18n.map[key] = arr;
            }
        }
    			...
    			if(xhr.readyState == 4){ 
                  if(xhr.status == 200 ){ 
                	  if (settings.debug) {
	                    ...
	                    parseData(xhr.responseText, settings);
	                    nextFile();
                  }
               }
    		};

    		xhr.open("GET", filename, settings.cache);
    		xhr.onerror = function(){
			   if (settings.debug) {
                    debug('Failed to download or parse ' + filename + '. errorThrown: ' );
                }
                if (jqXHR.status === 404) {
                ...
                if (pair.length > 0) {
                    ...
                    if (settings.mode == 'map' || settings.mode == 'both') {
                        ...
                        if (settings.namespace) {
                            $.kgi18n.map[settings.namespace][name] = value;
                        } else {
                            $.kgi18n.map[name] = value;
                        }
                    }
    ...
    $.kgi18n.normaliseLanguageCode = function (settings) {
