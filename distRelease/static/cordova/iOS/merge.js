 ...
 */
               ...
               channel.onCordovaReady.subscribe(function() {
                                                me.getInfo(function(info) {
                                                           ...
                                                           me.netType = info.NetconnType || 'unknown';
                                                           me.IP = info.IPAddresses || 'unknown';
                                                           me.wifiName = info.wifiName || 'unknown';
                                                           me.wifiBSSID = info.wifiBSSID || 'unknown';
...
cordova.define("xsf.window", function(require, exports, module) {
               ...
               return window.open(url, '_blank', 'location=no,closebuttoncaption=关闭,title=' + title +',enableviewportscale=yes,titleBar=yes');//传标题
               ...
               openWebView : function(json,callback){
               call('openWebView',[json],callback);
               },
...
//                        return;
//                    }
//                    exec(success, error, "BaiDuMapPlugin", "execute", [param.method,param.param]);
//                },
...
/* global cordova */
               ...
               getStatusBarHight:function(succeedCallback,errorCallback){
                    exec(succeedCallback,errorCallback, "StatusBar", "getStatusBarHight", []);
               },
...
cordova.define("inAppPurchase", function(require, exports, module) {
               function onSucceed(args){
               ...
               exec(callback,errorCallback, "InAppPurchasePlugin", callee,args);
               }
               var exec = require('cordova/exec');
               module.exports = {
               inAppPurchaseProduct:function(callback,errorCallback,args){
               call('purchase',[args],callback,errorCallback);
               }
               };
               });
...
cordova.define("xsf.chartutility", function(require, exports, module) {
               ...
               exec(callback,errorCallback, "ChartUtilityPlugin", callee,args);
               }
               var exec = require('cordova/exec');
...
cordova.define("xsf.sharedPreferences", function(require, exports, module) {
...
cordova.define("CustomeCamera", function(require, exports, module) {
               function onSucceed(args){
               ...
               exec(callback,errorCallback, "CDVCFCameraPlugin", callee,args);
               }
               var exec = require('cordova/exec');
               module.exports = {
               takeCustomeCamera:function(callback,errorCallback,args){
               call('takeCamera',[args],callback,errorCallback);
               }
               };
               });

cordova.define("ThirdAppOpen", function(require, exports, module) {
               function onSucceed(args){
               ...
               exec(callback,errorCallback, "ThirdAppOpenPlugin", callee,args);
               }
               var exec = require('cordova/exec');
               module.exports = {
               openApp:function(callback,errorCallback,args){
               call('openThirdApp',args,callback,errorCallback);
               }
               };
               });

cordova.define("DDLocation", function(require, exports, module) {
               function onSucceed(args){
               ...
               function call(callee,callback,errorCallback){
               callback = callback || onSucceed;
               errorCallback = errorCallback || onError;
               
               exec(callback,errorCallback, "DDLocationPlugin", callee);
               }
               var exec = require('cordova/exec');
               module.exports = {
               takeUserLocationInfo:function(callback,errorCallback){
               call('startLocation',callback,errorCallback);
               }
               };
               });
...
cordova.define("OpenPlugin", function(require, exports, module) {
        ...
        onSucceed = succeedCallback || onSucceed;
        onError = errorCallback || onError;
        exec(onSucceed,onError, "OpenPlugin", callee,args);
        }
        var exec = require('cordova/exec');
        module.exports = {
        openUrlOutSide : function(options,onSucceed,onError){
        call('openUrlOutSide',[options],onSucceed,onError);
        }
...
cordova.define("dreambox-NetSchoolJump", function(require, exports, module) {
    var exec = require('cordova/exec');
    var req = {
        open : function(arg,succeedCallback,errorCallback){
            exec(succeedCallback,errorCallback,"NetSchoolPlugin","open",[arg]);
        },encrypt : function(arg,succeedCallback,errorCallback){
            exec(succeedCallback,errorCallback,"NetSchoolPlugin","encrypt",[arg]);
        }
    };
    module.exports = req;
