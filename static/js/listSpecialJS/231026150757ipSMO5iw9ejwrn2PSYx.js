...
(function() {
 ...
 // };
  exportObj.link = function(listid1, moduleId1, pk1, vueData, itemValue) {
    ...
    let str = itemValue["S-UNIFY-DRAFT-0006"];
    ...
    todoId = str
      ...
      let prefix = itemValue["S-UNIFY-DRAFT-0006"]
        .split("#")[0]
        .split("/dist")[0];
  ...
  function setTimer(vueData) {
    ...
    if (!vueData.data.length) {
      ...
      listInterval = setInterval(() => {
        dsf.http
          .post(
            "fn/list/231026150757ipSMO5iw9ejwrn2PSYx/mobile/q?moduleId=231026100416j6grymApkOd87tP1kLi",
            params
          )
          .then(({ data }) => {
