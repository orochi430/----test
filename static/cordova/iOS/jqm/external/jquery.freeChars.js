...
;(function($){
  ...
  FreeChars.prototype = {
    ...
    countTick: function(){
      ...
      //zhangx
      console.log("available="+available  + ",this.count=" + this.count + ",maxLength=" + this.config.maxLength);
