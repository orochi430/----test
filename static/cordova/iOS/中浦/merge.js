...
cordova.define("xsf.window", function(require, exports, module) {
	...
	module.exports = {
		open : function(url,title,isToolBar){
                //alert(isToolBar);
            if(isToolBar){
               return window.open(url, '_blank', 'location=no,closebuttoncaption=关闭,title=' + title +',enableviewportscale=yes,titleBar=yes');
            }else{
               if(url.indexOf(":")<0){
...
cordova.define("xsf.pushmessage", function(require, exports, module) {
	...
	module.exports = {
        ...
        },openBaiduSettingView : function(data,onSucceed,onError){
            call('openBaiduSettingView',[],onSucceed,onError);
        }
	};
});
