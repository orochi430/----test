				...
				<div class="menu-list">
					...
					<div class="menu-child">
						<div v-for="(itm,idx) in item.child.slice(0,4)" @click="goRoute(itm)">
							<div class="text_right"><img :src="itm.img" :onerror="default_img"></div>
							<div class="child-content text_left">
								<span>
									{{itm.name}}
									<i class="badge" v-if="itm.badgeNum">{{itm.badgeNum | formatBadge}}</i>
								</span>
							</div>
						</div>
					</div>
