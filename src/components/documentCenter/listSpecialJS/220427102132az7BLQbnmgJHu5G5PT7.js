...
exportObj.link = function (listid, moduleId, pk, vueData, itemValue) {
  ...
  if (!itemValue["GLID.2205250937358SEjp9eXdvT1IhOX1Sx"].length) {
    dsf.http.post("fn/gomeaffAndSurvey/addGomeaffRead", data).then(res => {
      let result = res.data
  ...
  vueData.$router.push({
    path: `/commonForm/${itemValue["zw.A0004"]}/${itemValue["zw.A0001"]}?method=inbox&listId=220427111908dXHMbNRnDEEuSbLdeSe`
  })
}
