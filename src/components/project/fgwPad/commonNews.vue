        ...
        <div class="newslist leftarc">
            ...
            <div class="newsArt" v-for="(item,index) in weinei" :key="'w'+index" v-show="wnIndex==index">
                <div class="newsArtItem" v-for="(arc,i) in item.arcList" :key="arc.id" @click="goDetail(arc)">
                    ...
                    <div class="msg">
                        <p>
                            <img src="static/images/project/fgwPad/danwei.png" alt="" srcset="">
                            <span>{{ arc.deptName }}</span>
                        </p>
                        <p>
                            <img src="static/images/project/fgwPad/timer.png" alt="" srcset="">
                            <span>{{ arc.time }}</span>
                        </p>
                    </div>
                </div>
    ...
    <div class="newsRight">
        <div class="newslist">
            <div class="newsTab">
                ...
                <p class="more" @click="goTzDetail">更多</p>
            </div>
