<template>
  <div class="topic-container">
    <template v-if="files.length > 0">
      ...
      >
        <div
          :style="`background-image:url(${typeClass(file)})`"
          class="file-icon"
        ></div>
        <div class="file-desc">
    ...
    <van-popup v-model="showFile" :close-on-click-overlay="true" class="file-preview" lock-scroll position="bottom" style="height: 100vh">
      ...
      <div class="preview-outer">
        <enclosure-preview ref="enclosurePreview" :file="popFile" :is-preview="isPreview" :is-show-cur-person="true" :is-signature="true" @goPreview="goPreview" @goHandWrite="goHandWrite"></enclosure-preview>
      </div>
    </van-popup>
  </div>
</template>
